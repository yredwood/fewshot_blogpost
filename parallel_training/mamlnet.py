...
class MAMLNet(Network):
    def __init__(
        ...
        self.inner_loop_iter = 5 if isTr else 10
...
#        embedding = (_p - _q)**2
        ...
        self.outputs['loss'] = tf.reduce_mean(meta_lossbs, axis=(1,2)) #[0]
#        self.outputs['embedding'] = embedding
        ...
        if isTr:
            ...
            opt = tf.train.MomentumOptimizer(ip['lr_beta'], 0.9)
