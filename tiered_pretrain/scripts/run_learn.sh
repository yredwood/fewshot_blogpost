...
arch="wdres"
meta_arch="proto"
config="cl_tieredImagenet"  #for learn
#config="cl_miniImagenet"
name=Learner_${config}_${arch}_${meta_arch}_wd
...
CUDA_VISIBLE_DEVICES=$gpu python -u learning.py --maxe 80 --arch $arch \
    --config $config --bs 64 --gpuf 0.91 --name $name --aug $A --meta_arch $meta_arch \
